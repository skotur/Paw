            ...
            <Popover.Button
              ...
              className={cn(
                `main-tab group group absolute top-2 right-2 p-2 
                 ...
                 focus-visible:!ring-accent-green/80 active:bg-accent-green/20`,
                open && 'bg-accent-green/10 [&>div>svg]:text-accent-green'
              )}
            >
              <div className='group relative'>
                <HeroIcon
                  className='h-5 w-5 text-light-secondary group-hover:text-accent-green
                             group-focus-visible:text-accent-green dark:text-dark-secondary/80'
